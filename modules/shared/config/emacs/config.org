...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Oscar Vargas Torres"
    user-mail-address "oscarvarto@protonmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/oscarvarto/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/oscarvarto/bin" "/profile/bin" "/Users/oscarvarto/.npm-packages/bin" "/Users/oscarvarto/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
